...
import { GcsheetNaliService } from '../../services/gcsheet-nali.service';
import { ToastService } from '../../shared/toast/toast.service';
import { PaginationComponent } from '../../shared/pagination/pagination.component';

@Component({
  selector: 'app-gcsheet-nali',
  standalone: true,
          ...
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" [class.show]="showGcsheetMenu">
                ...
                <li><a class="dropdown-item active" style="color: #0d6efd; font-weight: 500;"><i class="bi bi-geo-alt me-2"></i>Nali</a></li>
    ...
    <div class="container mt-5">
      <div class="card">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
          <h4 class="mb-0"><i class="bi bi-geo-alt me-2"></i>Gcsheet Nali Master</h4>
          <div class="d-flex gap-2">
            ...
            <button class="btn btn-light btn-sm" (click)="openAddModal()"><i class="bi bi-plus-circle me-1"></i>Add Nali</button>
          </div>
        </div>
    ...
    @if (showModal()) {
      <div class="modal show d-block" tabindex="-1" style="background-color: rgba(0,0,0,0.5);">
        <div class="modal-dialog"><div class="modal-content">
          <div class="modal-header"><h5 class="modal-title">{{ isEditMode() ? 'Edit' : 'Add' }} Nali</h5><button type="button" class="btn-close" (click)="closeModal()"></button></div>
...
export class GcsheetNaliComponent implements OnDestroy {
  private service = inject(GcsheetNaliService);
  ...
  async saveData() {
    ...
    try {
      ...
      if (result.success) { this.toastService.success(`Nali ${this.isEditMode() ? 'updated' : 'created'} successfully`); this.closeModal(); await this.loadData(); } else { this.toastService.error(result.error); }
  ...
  exportToExcel(): void {
    ...
    setTimeout(() => { 
      ...
      XLSX.utils.book_append_sheet(wb, ws, 'Nali Master'); 
      XLSX.writeFile(wb, `gcsheet_nali_export_${new Date().toISOString().split('T')[0]}.xlsx`); 
