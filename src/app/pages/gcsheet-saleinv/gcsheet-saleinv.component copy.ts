                    ...
                    <tbody>
                      @for (detail of detailsArray.controls; track detail; let i = $index) {
                        <tr [formGroupName]="i">
                          <td>{{ i + 1 }}</td>
                          <td>
                            <input type="text" class="form-control form-control-sm" [value]="getPktname(i)" readonly>
                          </td>
                          <td>
    ...
    const itemsHtml = (data.details || []).map((d: any, idx: number) => {
      ...
      return `
        <tr>
          ...
          <td>${this.escapeHtml(d.pktname || '')}</td>
          <td>${''}</td>
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .items th:nth-child(3), .items td:nth-child(3) { width: 38%; }
            ...
            .items th:nth-child(7), .items td:nth-child(7) { width: 11%; }
